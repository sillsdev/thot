...
//-------------------------
unsigned int WordAligMatrix::getValue(unsigned int i, unsigned int j) const
{
  return matrix[i][j];
}
...
//-------------------------
std::vector<std::pair<unsigned int, unsigned int>> WordAligMatrix::obtainAdjacentCells(unsigned int i, unsigned int j)
{
