...
HmmAligModel::HmmAligModel() : hmmAlignmentTable{make_shared<HmmAlignmentTable>()}
{
  lexNumDenFileExtension = ".hmm_lexnd";
}

HmmAligModel::HmmAligModel(Ibm1AligModel& model)
    : Ibm1AligModel{model}, hmmAlignmentTable{make_shared<HmmAlignmentTable>()}
{
  lexNumDenFileExtension = ".hmm_lexnd";
}
...
void HmmAligModel::setLexSmIntFactor(double _lexSmoothInterpFactor, int verbose)
{
...
void HmmAligModel::setAlSmIntFactor(double _aligSmoothInterpFactor, int verbose)
{
...
void HmmAligModel::set_hmm_p0(Prob _hmm_p0)
{
  hmm_p0 = _hmm_p0;
}

void HmmAligModel::startTraining(int verbosity)
{
  clearTempVars();
...
void HmmAligModel::batchUpdateCounts(const vector<pair<vector<WordIndex>, vector<WordIndex>>>& pairs)
{
...
void HmmAligModel::batchMaximizeProbs()
{
...
Prob HmmAligModel::pts(WordIndex s, WordIndex t)
{
...
LgProb HmmAligModel::logpts(WordIndex s, WordIndex t)
{
...
Prob HmmAligModel::aProb(PositionIndex prev_i, PositionIndex slen, PositionIndex i)
{
...
LgProb HmmAligModel::logaProb(PositionIndex prev_i, PositionIndex slen, PositionIndex i)
{
  double logProb = unsmoothed_logaProb(prev_i, slen, i);
  if (isValidAlig(prev_i, slen, i))
  {
...
LgProb HmmAligModel::obtainBestAlignment(const vector<WordIndex>& srcSentIndexVector,
...
bool HmmAligModel::print(const char* prefFileName, int verbose)
{
  bool retVal;
...
void HmmAligModel::clearTempVars()
{
...
void HmmAligModel::viterbiAlgorithm(const vector<WordIndex>& nSrcSentIndexVector,
...
void HmmAligModel::viterbiAlgorithmCached(const vector<WordIndex>& nSrcSentIndexVector,
                                          const vector<WordIndex>& trgSentIndexVector,
...
double HmmAligModel::bestAligGivenVitMatricesRaw(const vector<vector<double>>& vitMatrix,
...
double HmmAligModel::bestAligGivenVitMatrices(PositionIndex slen, const vector<vector<double>>& vitMatrix,
                                              const vector<vector<PositionIndex>>& predMatrix,
                                              vector<PositionIndex>& bestAlig)
{
...
double HmmAligModel::forwardAlgorithm(const vector<WordIndex>& nSrcSentIndexVector,
...
double HmmAligModel::lgProbGivenForwardMatrix(const vector<vector<double>>& forwardMatrix)
{
...
PositionIndex HmmAligModel::getSrcLen(const vector<WordIndex>& nsrcWordIndexVec)
{
...
void HmmAligModel::calcAlphaBetaMatrices(const vector<WordIndex>& nsrcSent, const vector<WordIndex>& trgSent,
...
bool HmmAligModel::isFirstNullAligPar(PositionIndex ip, unsigned int slen, PositionIndex i)
{
  if (ip == 0)
  {
    if (i == slen + 1)
...
double HmmAligModel::calc_lanji_num(PositionIndex i, PositionIndex j, const vector<vector<double>>& alphaMatrix,
...
double HmmAligModel::calc_lanjm1ip_anji_num_je1(PositionIndex slen, PositionIndex i,
...
double HmmAligModel::calc_lanjm1ip_anji_num_jg1(PositionIndex ip, PositionIndex slen, PositionIndex i, PositionIndex j,
                                                const vector<vector<double>>& lexLogProbs,
...
double HmmAligModel::unsmoothed_logaProb(PositionIndex prev_i, PositionIndex slen, PositionIndex i)
{
...
double HmmAligModel::cached_logaProb(PositionIndex prev_i, PositionIndex slen, PositionIndex i)
{
...
void HmmAligModel::getHmmAligInfo(PositionIndex ip, PositionIndex slen, PositionIndex i, HmmAligInfo& hmmAligInfo)
{
...
bool HmmAligModel::isValidAlig(PositionIndex ip, PositionIndex slen, PositionIndex i)
{
  if (i <= slen)
    return true;
  else
...
bool HmmAligModel::isNullAlig(PositionIndex ip, PositionIndex slen, PositionIndex i)
{
  if (i <= slen)
    return false;
  else
...
PositionIndex HmmAligModel::getModifiedIp(PositionIndex ip, PositionIndex slen, PositionIndex i)
{
  if (i <= slen && ip > slen)
  {
    return ip - slen;
...
bool HmmAligModel::loadLexSmIntFactor(const char* lexSmIntFactorFile, int verbose)
{
  if (verbose)
...
bool HmmAligModel::printLexSmIntFactor(const char* lexSmIntFactorFile, int verbose)
{
  ofstream outF;
...
bool HmmAligModel::loadAlSmIntFactor(const char* alSmIntFactorFile, int verbose)
{
  if (verbose)
...
bool HmmAligModel::printAlSmIntFactor(const char* alSmIntFactorFile, int verbose)
{
  ofstream outF;
...
bool HmmAligModel::loadHmmP0(const char* hmmP0FileName, int verbose)
{
  if (verbose)
...
bool HmmAligModel::printHmmP0(const char* hmmP0FileName)
{
  std::ofstream outF;
