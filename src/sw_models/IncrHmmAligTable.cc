...
//-------------------------
void IncrHmmAligTable::setAligNumer(aSourceHmm asHmm, PositionIndex i, float f)
{
  // Grow aligNumer
...
//-------------------------
float IncrHmmAligTable::getAligNumer(aSourceHmm asHmm, PositionIndex i, bool& found)
{
  if (i >= aligNumer.size())
  {
...
//-------------------------
void IncrHmmAligTable::setAligDenom(aSourceHmm asHmm, float f)
{
  std::vector<std::pair<bool, float>> bdpVec;
...
//-------------------------
float IncrHmmAligTable::getAligDenom(aSourceHmm asHmm, bool& found)
{
...
//-------------------------
void IncrHmmAligTable::setAligNumDen(aSourceHmm asHmm, PositionIndex i, float num, float den)
{
...
//-------------------------
bool IncrHmmAligTable::load(const char* aligNumDenFile, int verbose /*=0*/)
{
...
//-------------------------
bool IncrHmmAligTable::loadPlainText(const char* aligNumDenFile, int verbose)
{
...
//-------------------------
bool IncrHmmAligTable::loadBin(const char* aligNumDenFile, int verbose)
{
  // Clear data structures
  clear();
