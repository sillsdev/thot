...
public:
  ...
  virtual LgProb obtainBestAlignmentCached(std::vector<WordIndex> srcSentIndexVector,
    std::vector<WordIndex> trgSentIndexVector, CachedHmmAligLgProb& cached_logap, WordAligMatrix& bestWaMatrix);
...
protected:
  ...
  void viterbiAlgorithmCached(const std::vector<WordIndex>& nSrcSentIndexVector,
    ...
    std::vector<std::vector<double>>& vitMatrix, std::vector<std::vector<PositionIndex>>& predMatrix);
    // Cached version of viterbiAlgorithm()

  double bestAligGivenVitMatricesRaw(const std::vector<std::vector<double>>& vitMatrix,
    const std::vector<std::vector<PositionIndex>>& predMatrix, std::vector<PositionIndex>& bestAlig);
  ...
  void calcAlphaBetaMatrices(const std::vector<WordIndex>& nsrcSent, const std::vector<WordIndex>& trgSent,
    ...
    std::vector<std::vector<double>>& alphaMatrix, std::vector<std::vector<double>>& betaMatrix);
  ...
  void calc_lanjm1ip_anji(unsigned int n, const std::vector<WordIndex>& nsrcSent, const std::vector<WordIndex>& trgSent,
    PositionIndex slen, const Count& weight, const std::vector<std::vector<double>>& cachedLexLogProbs,
    const std::vector<std::vector<double>>& alphaMatrix, const std::vector<std::vector<double>>& betaMatrix);
  void calc_lanjm1ip_anji_vit(unsigned int n, const std::vector<WordIndex>& nsrcSent,
    const std::vector<WordIndex>& trgSent, PositionIndex slen, const std::vector<PositionIndex>& bestAlig,
    const Count& weight);
  ...
  double calc_lanjm1ip_anji_num_je1(PositionIndex slen, PositionIndex i,
    const std::vector<std::vector<double>>& cachedLexLogProbs, const std::vector<std::vector<double>>& betaMatrix);
  double calc_lanjm1ip_anji_num_jg1(PositionIndex ip, PositionIndex slen, PositionIndex i, PositionIndex j,
    const std::vector<std::vector<double>>& cachedLexLogProbs, const std::vector<std::vector<double>>& alphaMatrix,
    const std::vector<std::vector<double>>& betaMatrix);
