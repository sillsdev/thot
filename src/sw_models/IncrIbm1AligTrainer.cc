...
void IncrIbm1AligTrainer::calcNewLocalSuffStats(pair<unsigned int, unsigned int> sentPairRange, int verbosity)
{
...
void IncrIbm1AligTrainer::incrMaximizeProbs()
{
...
float IncrIbm1AligTrainer::obtainLogNewSuffStat(float lcurrSuffStat, float lLocalSuffStatCurr, float lLocalSuffStatNew)
{
...
void IncrIbm1AligTrainer::clear()
{
  anji_aux.clear();
  incrLexCounts.clear();
}
