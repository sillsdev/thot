...
public:
  ...
  bool init_nth_entry(unsigned int n, PositionIndex nslen, PositionIndex tlen, unsigned int& mapped_n);
  ...
  unsigned int nji_size(unsigned int n, unsigned int j);
  unsigned int njiip_size(unsigned int n, unsigned int j, unsigned int i);
  void set(unsigned int n, unsigned int j, unsigned int i, unsigned int ip, float f);
  void set_fast(unsigned int mapped_n, unsigned int j, unsigned int i, unsigned int ip, float f);
  float get(unsigned int n, unsigned int j, unsigned int i, unsigned int ip);
  float get_fast(unsigned int mapped_n, unsigned int j, unsigned int i, unsigned int ip);
  float get_invp(unsigned int n, unsigned int j, unsigned int i, unsigned int ip);
  float get_invp_fast(unsigned int mapped_n, unsigned int j, unsigned int i, unsigned int ip);
  float get_invlogp(unsigned int n, unsigned int j, unsigned int i, unsigned int ip);
  float get_invlogp_fast(unsigned int mapped_n, unsigned int j, unsigned int i, unsigned int ip);
...
protected:
  ...
  // Auxiliary functions
  bool resizeIsRequired(unsigned int mapped_n, PositionIndex nslen, PositionIndex tlen);
  bool n_is_mapped_in_matrix(unsigned int n, unsigned int& np);
  void map_n_in_matrix(unsigned int n, unsigned int& np);
  ...
  void update_np_to_n_vector(unsigned int np, std::pair<bool, unsigned int> pbui);
  void update_n_to_np_vector(unsigned int n, std::pair<bool, unsigned int> pbui);

  // Functions to load and print matrices
  bool load_matrix_values(const char* anjiFile, int verbose);
