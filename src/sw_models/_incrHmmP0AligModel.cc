...
//-------------------------
bool _incrHmmP0AligModel::load(const char* prefFileName, int verbose /*=0*/)
{
  bool retVal = _incrHmmAligModel::load(prefFileName, verbose);
...
//-------------------------
bool _incrHmmP0AligModel::loadHmmP0(const char* hmmP0FileName, int verbose)
{
  if (verbose)
...
//-------------------------
double _incrHmmP0AligModel::unsmoothed_logaProb(PositionIndex prev_i, PositionIndex slen, PositionIndex i)
{
