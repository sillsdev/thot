...
public:
  HmmAligModel();
  HmmAligModel(Ibm1AligModel& model);
...
protected:
  ...
  HmmAligModel(HmmAligModel& model);
  ...
  LgProb obtainBestAlignmentCached(const std::vector<WordIndex>& srcSentIndexVector,
  ...
  double calc_lanjm1ip_anji_num_jg1(PositionIndex ip, PositionIndex slen, PositionIndex i, PositionIndex j,
                                    ...
                                    const std::vector<std::vector<double>>& betaMatrix);
  void getHmmAligInfo(PositionIndex ip, PositionIndex slen, PositionIndex i, HmmAligInfo& hmmAligInfo);
  bool isValidAlig(PositionIndex ip, PositionIndex slen, PositionIndex i);
  bool isNullAlig(PositionIndex ip, PositionIndex slen, PositionIndex i);
