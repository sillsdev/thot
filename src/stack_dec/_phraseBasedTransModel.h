...
class _phraseBasedTransModel: public BasePbTransModel<HYPOTHESIS>
{
 ...
 protected:
  ...
  Vector<std::string> getTransInPlainTextVecTs(const Hypothesis& hyp,set<PositionIndex>& unknownWords)const;
  Vector<std::string> getTransInPlainTextVecTps(const Hypothesis& hyp,set<PositionIndex>& unknownWords)const;
  Vector<std::string> getTransInPlainTextVecTrs(const Hypothesis& hyp,set<PositionIndex>& unknownWords)const;
  Vector<std::string> getTransInPlainTextVecTvs(const Hypothesis& hyp,set<PositionIndex>& unknownWords)const;
...
//---------------------------------
template<class HYPOTHESIS>
Vector<std::string> _phraseBasedTransModel<HYPOTHESIS>::getTransInPlainTextVecTs(const Hypothesis& hyp,
                                                                                 set<PositionIndex>& unknownWords)const
{
...
//---------------------------------
template<class HYPOTHESIS>
Vector<std::string> _phraseBasedTransModel<HYPOTHESIS>::getTransInPlainTextVecTps(const Hypothesis& hyp,
                                                                                  set<PositionIndex>& unknownWords)const
{
  Vector<WordIndex> nvwi;
  Vector<WordIndex> vwi;
...
//---------------------------------
template<class HYPOTHESIS>
Vector<std::string> _phraseBasedTransModel<HYPOTHESIS>::getTransInPlainTextVecTrs(const Hypothesis& hyp,
                                                                                  set<PositionIndex>& unknownWords)const
{
    Vector<WordIndex> nvwi;
  Vector<WordIndex> vwi;
...
//---------------------------------
template<class HYPOTHESIS>
Vector<std::string> _phraseBasedTransModel<HYPOTHESIS>::getTransInPlainTextVecTvs(const Hypothesis& hyp,
                                                                                  set<PositionIndex>& unknownWords)const
{
  Vector<WordIndex> nvwi;
  Vector<WordIndex> vwi;
