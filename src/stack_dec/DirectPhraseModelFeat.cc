...
/**
 * @file DirectPhraseModelFeat.cc
 *
 * @brief Definitions file for DirectPhraseModelFeat.h
 */
...
template <>
DirectPhraseModelFeat<PhrScoreInfo>::HypScoreInfo DirectPhraseModelFeat<PhrScoreInfo>::extensionScore(
