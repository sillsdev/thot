...
struct FeaturesInfo
{
  ...
  std::vector<InversePhraseModelFeat<SCORE_INFO>* > getInversePhraseModelFeatPtrs(std::vector<unsigned int>& featIndexVec);
  std::vector<SrcPosJumpFeat<SCORE_INFO>* > getSrcPosJumpFeatPtrs(std::vector<unsigned int>& featIndexVec);
};

//---------------
template<class SCORE_INFO>
std::vector<LangModelFeat<SCORE_INFO>* >
FeaturesInfo<SCORE_INFO>::getLangModelFeatPtrs(std::vector<unsigned int>& featIndexVec)
{
  featIndexVec.clear();
...
//---------------
template<class SCORE_INFO>
std::vector<DirectPhraseModelFeat<SCORE_INFO>* >
FeaturesInfo<SCORE_INFO>::getDirectPhraseModelFeatPtrs(std::vector<unsigned int>& featIndexVec)
{
  featIndexVec.clear();
...
//---------------
template<class SCORE_INFO>
std::vector<InversePhraseModelFeat<SCORE_INFO>* >
FeaturesInfo<SCORE_INFO>::getInversePhraseModelFeatPtrs(std::vector<unsigned int>& featIndexVec)
{
  featIndexVec.clear();
...
//---------------
template<class SCORE_INFO>
std::vector<SrcPosJumpFeat<SCORE_INFO>* >
FeaturesInfo<SCORE_INFO>::getSrcPosJumpFeatPtrs(std::vector<unsigned int>& featIndexVec)
{
  featIndexVec.clear();
