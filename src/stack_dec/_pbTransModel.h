...
//---------------------------------
template<class HYPOTHESIS>
std::vector<std::string> _pbTransModel<HYPOTHESIS>::getTransInPlainTextVecTs(const _pbTransModel<HYPOTHESIS>::Hypothesis& hyp,
                                                                             std::set<PositionIndex>& unknownWords)const
{
...
//---------------------------------
template<class HYPOTHESIS>
std::vector<std::string> _pbTransModel<HYPOTHESIS>::getTransInPlainTextVecTps(const _pbTransModel::Hypothesis& hyp,
                                                                              std::set<PositionIndex>& unknownWords)const
{
  std::vector<WordIndex> nvwi;
  std::vector<WordIndex> vwi;
...
//---------------------------------
template<class HYPOTHESIS>
std::vector<std::string> _pbTransModel<HYPOTHESIS>::getTransInPlainTextVecTrs(const _pbTransModel::Hypothesis& hyp,
                                                                              std::set<PositionIndex>& unknownWords)const
{
  std::vector<WordIndex> nvwi;
  std::vector<WordIndex> vwi;
...
//---------------------------------
template<class HYPOTHESIS>
std::vector<std::string> _pbTransModel<HYPOTHESIS>::getTransInPlainTextVecTvs(const _pbTransModel::Hypothesis& hyp,
                                                                              std::set<PositionIndex>& unknownWords)const
{
  std::vector<WordIndex> nvwi;
  std::vector<WordIndex> vwi;
