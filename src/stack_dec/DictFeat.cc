 ...
 * @file DictFeat.cc
 *
 * @brief Definitions file for DictFeat.h
 */

//--------------- Include files --------------------------------------

#include "stack_dec/DictFeat.h"

//--------------- DictFeat class functions

template <>
DictFeat<PhrScoreInfo>::HypScoreInfo DictFeat<PhrScoreInfo>::extensionScore(const std::vector<std::string>& srcSent,
                                                                            const HypScoreInfo& predHypScrInf,
                                                                            const PhrHypDataStr& predHypDataStr,
                                                                            const PhrHypDataStr& newHypDataStr,
                                                                            float weight, Score& unweightedScore)
{
