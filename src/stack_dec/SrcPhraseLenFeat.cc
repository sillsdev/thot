...
/**
 * @file SrcPhraseLenFeat.cc
 *
 * @brief Definitions file for SrcPhraseLenFeat.h
 */

//--------------- Include files --------------------------------------

#include "stack_dec/SrcPhraseLenFeat.h"

//--------------- SrcPhraseLenFeat class functions

template <>
SrcPhraseLenFeat<PhrScoreInfo>::HypScoreInfo SrcPhraseLenFeat<PhrScoreInfo>::extensionScore(
