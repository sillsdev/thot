...
/**
 * @file TrgPhraseLenFeat.cc
 *
 * @brief Definitions file for TrgPhraseLenFeat.h
 */
...
template <>
TrgPhraseLenFeat<PhrScoreInfo>::HypScoreInfo TrgPhraseLenFeat<PhrScoreInfo>::extensionScore(
